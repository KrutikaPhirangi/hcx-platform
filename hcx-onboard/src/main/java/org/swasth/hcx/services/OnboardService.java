...
//                    }
    ...
    private Map<String,Object> createMockParticipant(HttpHeaders headers, String role, Map<String, Object> participantDetails) throws Exception {
        ...
        User user = new User(mockParticipant.get(PARTICIPANT_NAME) + " Admin", (String) mockParticipant.get(PRIMARY_EMAIL), (String) mockParticipant.get(PRIMARY_MOBILE), childParticipantCode);
        createOrAddUser(headers, user, childParticipantCode, Arrays.asList(ADMIN, CONFIG_MANAGER));
    ...
    private Map<String, Object> getMockParticipantBody(Map<String, Object> participantDetails, String role, String parentParticipantCode) throws Exception {
        ...
        mockParticipant.put(PRIMARY_MOBILE, certificate.getOrDefault(PRIMARY_MOBILE,""));
