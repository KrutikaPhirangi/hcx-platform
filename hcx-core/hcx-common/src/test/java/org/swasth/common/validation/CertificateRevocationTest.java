...
//        X509Certificate x509Certificate = parseCertificateFromString(certificate);
//        CertificateRevocation revocation = new CertificateRevocation(x509Certificate);
//        System.out.println(revocation.checkStatus());
