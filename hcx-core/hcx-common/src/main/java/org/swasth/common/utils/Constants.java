...
public class Constants {
    ...
    public static final List<String> PROVIDER_SPECIFIC_ROLES = Arrays.asList("provider.hospital", "provider.clinic", "provider.practitioner", "provider.diagnostics", "provider.pharmacy", "bsp");
